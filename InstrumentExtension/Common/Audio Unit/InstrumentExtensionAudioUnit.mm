//
//  InstrumentExtensionAudioUnit.mm
//  InstrumentExtension
//
//  Created by Eugene Clewlow on 1/25/23.
//

#import "InstrumentExtensionAudioUnit.h"

#import <AVFoundation/AVFoundation.h>
#import <CoreAudioKit/AUViewController.h>

#import "InstrumentExtensionAUProcessHelper.hpp"
#import "InstrumentExtensionDSPKernel.hpp"


// Define parameter addresses.

@interface InstrumentExtensionAudioUnit ()
...
@implementation InstrumentExtensionAudioUnit {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    InstrumentExtensionDSPKernel _kernel;
...
- (void)setupParameterCallbacks {
    ...
    __block InstrumentExtensionDSPKernel *kernel = &_kernel;
