...
private let log = Logger(subsystem: "com.eugeneclewlow.plugintest.InstrumentExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<InstrumentExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try InstrumentExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? InstrumentExtensionAudioUnit else {
            log.error("Unable to create InstrumentExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(InstrumentExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = InstrumentExtensionMainView(parameterTree: observableParameterTree)
