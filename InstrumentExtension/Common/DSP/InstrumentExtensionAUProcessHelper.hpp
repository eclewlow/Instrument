//
//  InstrumentExtensionAUProcessHelper.hpp
//  InstrumentExtension
//
...
{
public:
    AUProcessHelper(InstrumentExtensionDSPKernel& kernel, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    InstrumentExtensionDSPKernel& mKernel;
